...
The demo begins by outputting the versions of Python, Java, and PySpark being used.
...
Integrate with Trino for other SQL-Datasources… → link to end-to-end-security-demo
