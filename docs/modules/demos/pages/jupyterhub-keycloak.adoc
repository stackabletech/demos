...
You will be redirected to the Keycloak login, where you can enter one of the aforementioned users:
...
You can inspect the S3 buckets by adding a port forward on port 9001 of the minio Pod and logging in with `admin/adminadmin`:
