...
:demo-code: https://github.com/stackabletech/demos/blob/release-24.3/demos/data-lakehouse-iceberg-trino-spark/create-spark-ingestion-job.yaml
...
xref:secret-operator:index.adoc[Secret Operator] (e.g. Warning: Potential Security Risk Ahead). In that case, you
...
Please have a look at the xref:trino:usage-guide/connect_to_trino.adoc[trino-operator documentation on how to
