...
Libraries can be added to a custom *product* image launched by the notebook. In this section a Spark job is defined:
...
This is prepared by taking a Spark image, in this `docker.stackable.tech/stackable/pyspark-k8s:3.3.0-stackable23.4.0`, installing specific python libraries, and re-tagging the image:
