...
[NOTE]
====
This demo is a condensed form of the xref:data-lakehouse-iceberg-trino-spark.adoc[] demo focusing on using the
...
xref:data-lakehouse-iceberg-trino-spark.adoc[] demo.
====
...
Have a look at the xref:operators:trino:usage-guide/connect_to_trino#_connect_with_dbeaver[documentation] on how to
