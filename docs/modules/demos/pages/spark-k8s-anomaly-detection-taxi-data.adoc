...
:description: Deploy a Kubernetes-based Spark demo for anomaly detection using the infamous New York taxi dataset, featuring Trino, Spark, MinIO, and Superset.
